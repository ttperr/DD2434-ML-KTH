...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{py_files/14_contours.png}
    \caption{Contours of exact posteriors.}
    \label{fig:3.14}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.2]{py_files/15_contours.png}
    \caption{Contours of the approximations by VI.}
    \label{fig:3.15.1}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{py_files/15_elbo.png}
    \caption{ELBO plot.}
    \label{fig:3.15.2}
\end{figure}
