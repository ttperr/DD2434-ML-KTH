...
\lstinputlisting[label = {alg:1.2-reparam}]{py_files/1.2-reparam.py}
\subsubsection{Loss function}\label{appendix:1.2-loss}
\lstinputlisting[label = {alg:1.2-loss}]{py_files/1.2-loss.py}
\subsubsection{Generation from test data}\label{appendix:1.2-gen_test}
\lstinputlisting[label = {alg:1.2-gen_test}]{py_files/1.2-gen_test.py}
\subsubsection{Generation from noise}\label{appendix:1.2-gen}
\lstinputlisting[label = {alg:1.2-gen}]{py_files/1.2-gen.py}
